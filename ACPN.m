...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%                                         
%%                                                  
[N,d] = size(Data); % N est le nombre d'echanttillon , d est le nombre des paramètre de depart

%% ----- Centrage et reduction du jeu de donnees si necessaire ------%

Data = (Data-ones(N,1)*mean(Data))./(ones(N,1)*std(Data));
...
coor = Data * V;     % Calcul des nouvelles coordonnees des points de x, par proj-
